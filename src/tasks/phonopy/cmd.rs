...
pub struct DirWithDisps<P: AsPath> {
    ...
    pub(crate) super_meta: HList2<meta::SiteElements, meta::SiteMasses>,
}
...
impl<P: AsPath> DirWithDisps<P> {
    ...
    pub fn primitive_structure(&self) -> FailResult<(Coords, HList2<meta::SiteElements, meta::SiteMasses>)>
    ...
    #[allow(unused)]
    pub fn superstructure(&self) -> (&Coords, HList2<meta::SiteElements, meta::SiteMasses>)
...
pub struct Rsp2StyleDisplacements {
    ...
    pub super_meta: HList2<meta::SiteElements, meta::SiteMasses>,
...
impl<P: AsPath> DirWithForces<P> {
    ...
    #[allow(unused)]
    pub fn structure(&self) -> FailResult<(Coords, HList2<meta::SiteElements, meta::SiteMasses>)>
    { read_input_structure_with_mass(self) }
...
fn read_input_structure_with_mass(
    dir: impl AsPath,
) -> FailResult<(Coords, HList2<meta::SiteElements, meta::SiteMasses>)>
{
